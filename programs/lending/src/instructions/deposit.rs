...
// process deposit --> CPI from the user's token account to the bank's token account
// calculate the shares to the bank and new shares for the user 
pub fn process_deposit(ctx: Context<Deposit>, amount: u64) -> Result<()> {
    ...
    // The above match statement can easily have new branches adden when additional assets are added to the protocol 
