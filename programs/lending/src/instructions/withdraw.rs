...
// 3. Update user's deposited amoubt and total collateral value
// 4. Update bank's total deposits and total deposit shares
// 5. Update user's deposited shares    
...
pub fn process_withdraw(ctx: Context<Withdraw>, amount: u64) -> Result<()> {
    ...
    deposited_value = match ctx.accounts.mint.to_account_info().key() {
